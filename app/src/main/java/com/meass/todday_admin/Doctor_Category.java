...
public class Doctor_Category extends AppCompatActivity {
    String category;
    DocumentReference documentReference;
    RecyclerView recyclerView;
    Doctor_Cate getDataAdapter1;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_doctor__category);
        ...
        getDataAdapter1 = new Doctor_Cate(getList);
        firebaseFirestore = FirebaseFirestore.getInstance();
        documentReference = firebaseFirestore.collection(category).document();
