...
//Emergency_Adapter
public class Emergency_Adapter extends RecyclerView.Adapter<Emergency_Adapter.myView> {
    private final List<Temp_Doctor> data;
    FirebaseAuth firebaseAuth;
    FirebaseFirestore firebaseFirestore;

    public Emergency_Adapter(List<Temp_Doctor> data) {
        this.data = data;
    }
    ...
    public myView onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        return new Emergency_Adapter.myView(view);
    }

    @Override
    public void onBindViewHolder(@NonNull  Emergency_Adapter.myView holder, int position) {
