...
public class Today_Adapter extends RecyclerView.Adapter<Today_Adapter.myView> {
    private final List<Temp_Doctor> data;
    FirebaseAuth firebaseAuth;
    FirebaseFirestore firebaseFirestore;

    public Today_Adapter(List<Temp_Doctor> data) {
        this.data = data;
    }
    ...
    public myView onCreateViewHolder(@NonNull  ViewGroup parent, int viewType) {
        ...
        return new Today_Adapter.myView(view);
    }

    @Override
    public void onBindViewHolder(@NonNull  Today_Adapter.myView holder, int position) {
