...
public class Patient_List extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        firebaseFirestore = FirebaseFirestore.getInstance();
        documentReference = firebaseFirestore.collection("AllPatients").document();
        recyclerView = findViewById(R.id.blog_list_view);
        recyclerView.setHasFixedSize(true);
        recyclerView.setLayoutManager(new LinearLayoutManager(Patient_List.this));
    ...
    private void reciveData() {
        ...
        firebaseFirestore.collection("AllPatients").addSnapshotListener(new EventListener<QuerySnapshot>() {
            @Override
