...
public class Show_Images extends AppCompatActivity {
    ...
    List<SliderData> getList;
    String databasekey;
    KProgressHUD progressHUD;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_show__images);
        ...
        progressHUD = KProgressHUD.create(Show_Images.this);
            ...
            public void onEvent(@Nullable QuerySnapshot queryDocumentSnapshots, @Nullable FirebaseFirestoreException e) {
                for (DocumentChange ds:queryDocumentSnapshots.getDocumentChanges()) {
                 ...
                 Toast.makeText(MainActivity2.this, "" + first, Toast.LENGTH_SHORT).show();*/
                        SliderData get=ds.getDocument().toObject(SliderData.class);
                        getList.add(get);
